...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
    <a class="navbar-brand" href="#"><fmt:message key="addQuestion.title"/></a>
    <jsp:include page="navbar.jsp"/>
</nav>
<div class="container">
    <form class="needs-validation" action="questions" method="post" novalidate>
        <input hidden name="action" value="addQuestion"/>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input class="form-control" type="text" name="answerA" value="${answerA}" id="inputAnswerA" required maxlength="50"
                       pattern=".*\S+.*">
            </div>
            <div class="form-group col-md-6">
                <label for="inputAnswerB"><fmt:message key="questions.answer.b"/></label>
                <input class="form-control" type="text" name="answerB" value="${answerB}" id="inputAnswerB" required maxlength="50"
                       pattern=".*\S+.*">
            </div>
            <div class="form-group col-md-6">
                <label for="inputAnswerC"><fmt:message key="questions.answer.c"/></label>
                <input class="form-control" type="text" name="answerC" value="${answerC}" id="inputAnswerC" required maxlength="50"
                       pattern=".*\S+.*">
            </div>
            <div class="form-group col-md-6">
                <label for="inputAnswerD"><fmt:message key="questions.answer.d"/></label>
                <input class="form-control" type="text" name="answerD" value="${answerD}" id="inputAnswerD" required maxlength="50"
                       pattern=".*\S+.*">
            </div>
        </div>
        <div class="form-group">
