...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
    <a class="navbar-brand" href="#"><fmt:message key="addQuiz.title"/> </a>
    ...
    <form class="needs-validation" action="quizzes" method="post" novalidate>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="quizName" value="${quizName}" id="inputQuizName"
                       minlength="5" maxlength="50" required pattern=".*\S+.*">
                <div class="invalid-feedback">
                    <fmt:message key="validation.add.quiz.name"/>
                </div>
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" name="time" value="${quizTime}" id="inputTime" required
                       minlength="1" maxlength="3" pattern="^0*([1-9]|[1-9][0-9]|1[0-7][0-9]|180)$">
                <div class="invalid-feedback">
                    <fmt:message key="validation.add.quiz.time"/>
                </div>
            </div>
        </div>
